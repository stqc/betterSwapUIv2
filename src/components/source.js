...
export const getFactoryContract = async ()=>{
    ...
    factory = await new web3.eth.Contract(factoryABI,"0x6f01b192DC189e906F4333CB6C7f77e4E76BA79D");
...
export const createPool=async (thresh)=>{
 ...
 export const createToken= async (name_,symbol,supply,LPTax,BurnTax,addition,wallets)=>{
    if(!ref){
        ref=factory._address;
        console.log(ref);
    }    var tokenFactory_=new web3.eth.Contract(tokenFactoryABI,"0x4ff7DFB6968aE418105569c023d5eC6632A2CccF");
